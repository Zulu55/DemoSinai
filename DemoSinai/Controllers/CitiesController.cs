...
namespace DemoSinai.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CityId,Name,DepartmentId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CityId,Name,DepartmentId")] City city)
        {
            if (ModelState.IsValid)
            {
